...
describe("GET /api/v4/user", () => {
  ...
  const dateCallsExpected = [
    {
      library: "date",
      input: "now",
      output: "1715711599077",
      id: "c20503e8a7d11c23",
      timestamp: 1715711599077000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:19.078Z",
      id: "7444ae235f122f19",
      timestamp: 1715711599078000,
      startup: false,
    },
    {
      library: "date",
    ...
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:19.084Z",
      id: "e7d3b03c6f8b9fd6",
      timestamp: 1715711599084000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:19.085Z",
      id: "b359b876faa96a4c",
      timestamp: 1715711599085000,
      startup: false,
    },
    {
      library: "date",
      input: "now",
      output: "1715711599085",
      id: "16a554be109ddff9",
      timestamp: 1715711599085000,
      startup: false,
    },
    {
      library: "date",
      input: "now",
      output: "1715711599086",
      id: "8e0711109c430c05",
      timestamp: 1715711599086000,
      startup: false,
    },
    {
      library: "date",
    ...
    },
    {
      library: "date",
      input: "now",
      output: "1715711599087",
      id: "403292652f64f577",
      timestamp: 1715711599087000,
      startup: false,
    },
    {
      library: "date",
    ...
    },
    {
      library: "date",
      input: "now",
      output: "1715711599088",
      id: "d69dcafa9486e0a8",
      timestamp: 1715711599088000,
      startup: false,
    },
    {
      library: "date",
  ...
  afterEach(async () => {
    ...
    utils.serializeTestResults("generated/test_results/7.json", {
      traceId: "af1e498db4daa35f420b3eb374059305",
