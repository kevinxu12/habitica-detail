...
describe("PUT /api/v4/user", () => {
  ...
  const cryptoCallsExpected = [
    ...
    },
    {
      ...
      output: {
        type: "Buffer",
        data: [
          31, 246, 23, 221, 98, 246, 125, 132, 239, 121, 178, 133, 202, 181,
          141, 242, 170, 225, 121, 67, 0, 237, 33, 61, 191, 41, 233, 26, 105,
          179, 144, 130,
        ],
      },
      id: "961ca6afc7104e95",
      timestamp: 1715711604783000,
      startup: false,
    },
  ];
  ...
  const dateCallsExpected = [
    {
      library: "date",
      input: "now",
      output: "1715711604786",
      id: "369ac8cf4dae1f78",
      timestamp: 1715711604786000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:24.787Z",
      id: "88e04fe777b0b965",
      timestamp: 1715711604787000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:24.788Z",
      id: "5e1b7d42aaa13906",
      timestamp: 1715711604788000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:24.795Z",
      id: "d0d108484dc7626f",
      timestamp: 1715711604795000,
      startup: false,
    },
    {
      library: "date",
      input: "now",
      output: "1715711604799",
      id: "3455bf52a1921db0",
      timestamp: 1715711604799000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:24.800Z",
      id: "aaef867e0a52ea02",
      timestamp: 1715711604800000,
      startup: false,
    },
    {
      library: "date",
  ...
  afterEach(async () => {
    ...
    // Emit test results.
    utils.serializeTestResults("generated/test_results/16.json", {
      traceId: "52812a52ac6697c4da6f8a491bedbadb",
