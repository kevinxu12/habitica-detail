...
describe("GET /api/v4/tasks/user", () => {
  ...
  const dateCallsExpected = [
    {
      library: "date",
      input: "now",
      output: "1715711599080",
      id: "02404171118e268f",
      timestamp: 1715711599080000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:19.080Z",
      id: "afe36f780acbef69",
      timestamp: 1715711599080000,
      startup: false,
    },
    ...
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:19.092Z",
      id: "bff0452426dc7547",
      timestamp: 1715711599092000,
      startup: false,
    },
    {
      library: "date",
      input: "now",
      output: "1715711599093",
      id: "c57d00b8135c07e1",
      timestamp: 1715711599093000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:19.093Z",
      id: "f469004440283b4e",
      timestamp: 1715711599093000,
      startup: false,
    },
    ...
    },
    {
      library: "date",
      input: "now",
      output: "1715711599117",
      id: "531cef5bb3ce581c",
      timestamp: 1715711599117000,
      startup: false,
    },
    {
      library: "date",
  ...
  afterEach(async () => {
    ...
    // Emit test results.
    utils.serializeTestResults("generated/test_results/8.json", {
      traceId: "e7739ab007808440ee8a521c540ce37a",
