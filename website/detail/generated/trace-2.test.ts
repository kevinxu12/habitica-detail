...
describe("POST /api/v4/user/auth/verify-username", () => {
  ...
  const dateCallsExpected = [
    {
      library: "date",
      input: "now",
      output: "1715711581465",
      id: "ce65b95c37cfadbb",
      timestamp: 1715711581465000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:01.466Z",
      id: "08dd43e2e893c5af",
      timestamp: 1715711581466000,
      startup: false,
    },
    {
      library: "date",
      input: "Date.new",
      output: "2024-05-14T18:33:01.467Z",
      id: "548405692b836f2f",
      timestamp: 1715711581467000,
      startup: false,
    },
  ];
  ...
  afterEach(async () => {
    ...
    utils.serializeTestResults("generated/test_results/2.json", {
      traceId: "e017b1b8238174d7445af90f2465a287",
